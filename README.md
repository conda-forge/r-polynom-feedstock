...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1456&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-polynom-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-polynom` can be installed with `conda`:
...
```
mamba install r-polynom
```

It is possible to list all of the versions of `r-polynom` available on your platform with `conda`:
...
```
mamba search r-polynom --channel conda-forge
```
...
mamba repoquery search r-polynom --channel conda-forge

# List packages depending on `r-polynom`:
mamba repoquery whoneeds r-polynom --channel conda-forge

# List dependencies of `r-polynom`:
mamba repoquery depends r-polynom --channel conda-forge
```
